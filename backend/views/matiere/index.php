...
/* @var $searchModel backend\models\MatiereSearch */
                        ...
                        <table id="example5" class="display" style="min-width: 845px">
                            <div class="matiere-index">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <p>
                                            <?= Html::a(' Ajouter une matière', ['create'], ['class' => 'btn btn-primary fa fa-plus-square fa-8x']) ?>
                                     ...
                                     /*    [
                                            ...
                                            'buttons' => [
                                                ...
                                                'view' => function ($url, $data) {
                                                    $url = 'view_matiere?key=' . $data->key_matiere;
                                        ...
                                        [
                                            ...
                                            'buttons' => [
                                                ...
                                                'update' => function ($url, $data) {
                                                    $url = 'update_matiere?key=' . $data->key_matiere;
                                        ...
                                        [
                                            ...
                                            'buttons' => [
                                                ...
                                                'delete' => function ($url, $data) {
                                                    $url = 'delete_matiere?key=' . $data->key_matiere;

                                                    return Html::a('<i class="fa fa-trash-o fa-8x"></i>', '#', ['onClick' => 'delete_element(\'' . $data->key_matiere . '\')', 'class' => 'btn btn-danger btn-sm', "data-toggle" => "modal", "data-target" => "#exampleModalCenter"]);
                                                }
                                            ],
                                        ],
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" value="" id="keyMati">
...
<script>
    function showUpdateModal(key_matiere) {
        document.getElementById('key_matiere').value = key_matiere;
    }

    function saveUpdateMatiere() {
        let key_memomatiere = document.getElementById('key_memomatiere').value;
        if (key_matiere != "") {
            let url = "<?= Yii::$app->homeUrl ?>update_matiere";
            $.ajax({
                url: url,
                method: "post",
                data: {
    ...
    function delete_element(key_element) {
        document.getElementById('keyMati').value = key_element;
        document.getElementById('exampleModalLongTitle').innerHTML = 'Confirmation de suppression';
        document.getElementById('modalDeleteContent').innerHTML = 'Vous êtes sur le point de supprimer cette matière, cette action est irréverssible !';
    }

    function vdelete_element() {
        var url = "<?= Yii::$app->homeUrl ?>delete_matieref";
        var key_element = document.getElementById('keyMati').value;
        $.ajax({
            url: url,
            method: "get",
            data: {
